...
%% L2 cache size plot
CPI5 = [1.760280 1.676947 1.649316; 1.117702 1.109419 1.109120; 1.188197 1.188197 1.188197; 10.281658 10.276385 10.270363; 3.498891 3.495573 3.498620];  
e = bar(CPI5) 
e(1).FaceColor = [0.9290 0.6940 0.1250];
e(2).FaceColor = [0.6350 0.0780 0.1840];
e(3).FaceColor = [0.4940 0.1840 0.5560];
set(gca,'xticklabels',benchmarks)
title('L2 cache size - CPI')
xlabel('Benchmarks','FontSize',15)
ylabel('CPI','FontSize',15)
legend({'512kB','2MB', '4MB'},'Location','northeast', 'FontSize',10);

%% L2 cache associativity plot
CPI6 = [1.675758 1.676947 1.677165 1.677243; 1.109410 1.109419 1.109439 1.109410; 1.188197 1.188197 1.188197 1.188197; 10.276302 10.276385 10.276725 10.273894; 3.495573 3.495573 3.495573 3.495573];  
f = bar(CPI6) 
f(1).FaceColor = [0.9290 0.6940 0.1250];
f(2).FaceColor = [0.6350 0.0780 0.1840];
f(3).FaceColor = [0.4940 0.1840 0.5560];
f(4).FaceColor = [0.3010 0.7450 0.9330];
set(gca,'xticklabels',benchmarks)
title('L2 associativity - CPI')
xlabel('Benchmarks','FontSize',15)
ylabel('CPI','FontSize',15)
legend({'4','8', '16', '32'},'Location','northeast', 'FontSize',10);

%% Cacheline size plot
CPI7 = [1.853301 1.676947 1.661516; 1.150503 1.109419 1.085983; 1.196766 1.188197 1.185385; 17.645921 10.276385 6.805894; 5.606497 3.495573 2.581573];  
k = bar(CPI7) 
k(1).FaceColor = [0.4660 0.6740 0.1880];
k(2).FaceColor = [0 0.4470 0.7410];
k(3).FaceColor = [0.3010 0.7450 0.9330];
set(gca,'xticklabels',benchmarks)
